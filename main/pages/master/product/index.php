...
<div class="border rounded-xl">
  <div class="px-6 py-2 flex justify-between items-center">
    ...
    <a href="?page=master-product&act=add" class="text-center py-2 px-4 inline-flex items-center gap-x-2 text-xs font-semibold rounded-lg border border-transparent bg-green-700 text-white hover:bg-green-800 disabled:opacity-50 disabled:pointer-events-none transition-all">
  ...
  <hr>
  <div class="p-6">
    <?= simpleTable($getProducts, $columns, $get_url)  ?>
  </div>
</div>