<?php
function simpleTable($data, $columns, $get_url)
{
    if (empty($data)) {
    ...
    $html .= '<tr>';
    $html .= '<th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">No</th>';
    foreach ($columns as $key => $column) {
        $html .= '<th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">' . $column . '</th>';
    }
    $html .= '<th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Actions</th>';
    $html .= '</tr>';
    $html .= '</thead>';
